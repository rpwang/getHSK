$( document ).ready(function() {
	...
	//get ready for the setting config
	function setmode(){
	// event pressing play button
		// check for all values have been filled in
		// loading screen (ajax) when loaded go to play thats it
		var url; //normal-hsk1-120-hsk2-0	
	}
	$(":button[name=mode]").click(function() {
		alert($(this).val())
		$( "#lol" ).remove();
	});
	
	
	// event handler menu1 button click
